...
INSERT INTO `sys_role` VALUES (3, '测试人员', '测试', 3, '1', '0', '0', 'admin', '2020-03-31 14:39:26', 'admin', '2020-05-13 16:08:31', NULL);
...
INSERT INTO `sys_user` VALUES (4, 101, 'test1', 'test1', '00', '', '', '0', '', '$2a$10$iKMMV.XfjiFTKe3KY5aTY.Rom7Q22p7RsOioTEr7/9lUeYu21UPHW', '0', '0', '', NULL, 'admin', '2020-04-28 16:37:58', '', NULL, NULL);
...
CREATE TABLE `zh_collect_record`  (
  ...
  `type` int(1) NULL DEFAULT 1 COMMENT '记录类型,1已入库走航数据实时走航或者导入走航',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '走航记录' ROW_FORMAT = Compact;
...
CREATE TABLE `zh_config`  (
  ...
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置信息' ROW_FORMAT = Compact;
...
INSERT INTO `zh_device` VALUES (1, 'SPIMS', 'SPIMS-1001', '示例', '示例', NULL, 0, 0, 0, 0, NULL, '2020-04-29 09:48:15', '', NULL, NULL);
...
INSERT INTO `zh_point` VALUES (1, '示例敏感点', NULL, NULL, NULL, '2020-04-29 09:48:28', '', NULL, NULL);
