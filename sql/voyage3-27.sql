...
) ENGINE = InnoDB AUTO_INCREMENT = 276 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Compact;
...
INSERT INTO `sys_menu` VALUES (1063, 'VOC走航', 1061, 2, 'map', 'voyage/analysis/map/index', 1, 'C', '0', 'voyage:analysis:map:index', 'component', 'admin', '2020-02-22 00:05:54', 'admin', '2020-03-27 20:39:28', '');
...
INSERT INTO `sys_menu` VALUES (1125, '走航测试', 1061, 4, 'cesium/test', 'voyage/analysis/cesium/test', 1, 'C', '1', 'voyage:analysis:cesium:test', '404', 'admin', '2020-03-06 15:21:50', 'admin', '2020-03-27 20:47:20', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 143 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `zh_collect_record` VALUES (1, 'SPIMS001', '2019-09-26 18:51:00', '2019-09-26 19:06:46', '广州禾信');
